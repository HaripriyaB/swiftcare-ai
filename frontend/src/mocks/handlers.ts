...
let continuityCards = [
  { card_id: 'demo-card-1', patient_id: 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaa0001', patient_name: 'Fannie Kuhn', priority: 'HIGH', priority_score: 0.94, action_type: 'CONTACT_FOR_FOLLOW_UP', action_label: 'Call to arrange follow-up', why_now: 'The follow-up window has passed and no future visit is scheduled.', evidence: [{ label: 'Last visit', value: '842 days ago', source: 'encounter' }, { label: 'Open care gap', value: 'Preventive follow-up', source: 'continuity view' }], status: 'OPEN', rule_version: 'demo-v1', created_at: '2026-09-10T07:45:00Z', updated_at: '2026-09-10T07:45:00Z', disclaimer: 'Staff review required.' },
  { card_id: 'demo-card-2', patient_id: 'bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbb0001', patient_name: 'Harold Nguyen', priority: 'HIGH', priority_score: 0.89, action_type: 'REVIEW_WITH_CARE_TEAM', action_label: 'Review repeated recent visits', why_now: 'Recent utilization suggests a coordination review may help.', evidence: [{ label: 'Recent encounters', value: '8 in 90 days', source: 'encounter' }, { label: 'Active medications', value: '6', source: 'medication' }], status: 'OPEN', rule_version: 'demo-v1', created_at: '2026-09-10T07:30:00Z', updated_at: '2026-09-10T07:30:00Z', disclaimer: 'Staff review required.' },
  { card_id: 'demo-card-3', patient_id: 'bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbb0002', patient_name: 'Maya Patel', priority: 'MEDIUM', priority_score: 0.67, action_type: 'CONTACT_FOR_FOLLOW_UP', action_label: 'Confirm a follow-up appointment', why_now: 'A routine follow-up remains overdue.', evidence: [{ label: 'Last visit', value: '400 days ago', source: 'encounter' }, { label: 'Care pattern', value: 'Gap in care', source: 'continuity view' }], status: 'OPEN', rule_version: 'demo-v1', created_at: '2026-09-10T07:15:00Z', updated_at: '2026-09-10T07:15:00Z', disclaimer: 'Staff review required.' },
  { card_id: 'demo-card-4', patient_id: 'bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbb0003', patient_name: 'Luis Ortiz', priority: 'LOW', priority_score: 0.42, action_type: 'REVIEW_WITH_CARE_TEAM', action_label: 'Review medication coordination', why_now: 'Multiple active medications are recorded for operational awareness.', evidence: [{ label: 'Active medications', value: '4', source: 'medication' }, { label: 'Last visit', value: '510 days ago', source: 'encounter' }], status: 'OPEN', rule_version: 'demo-v1', created_at: '2026-09-10T06:50:00Z', updated_at: '2026-09-10T06:50:00Z', disclaimer: 'Staff review required.' },
]
