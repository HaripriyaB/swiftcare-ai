...
from agents.patient_lookup import format_matches_table, search_patients_core

from ..bq_client import fq, run_query
from ..logging import log_tool_call

# Re-export for tests that import format_matches_table from this module.
__all__ = ["search_patients", "format_matches_table"]
